...
namespace myapp {
    ...
    public:
        ...
        // Setters for add-ons
        void set_egg(bool has_egg) { has_egg_ = has_egg; }
        void set_cheese(bool has_cheese) { has_cheese_ = has_cheese; }
        void set_bacon(bool has_bacon) { has_bacon_ = has_bacon; }
        void set_fish(bool has_fish) { has_fish_ = has_fish; }
        void set_vegetable(bool has_vegetable) { has_vegetable_ = has_vegetable; }
